...
class TL extends Thread{
	...
	static TL tl(){Thread t=Thread.currentThread();return t instanceof TL?(TL)t:MainTest01.global;}
	...
	static MainTest01.Json.Output jo(){
		Object o=m("jo");
		MainTest01.Json.Output j=o instanceof MainTest01.Json.Output?
		(MainTest01.Json.Output)o
		:null;if(j==null)
			m("jo",j=new MainTest01.Json.Output());
		return j;}
}//class TL

public class MainTest01 extends TL{
AsicsScanner scan;//Map config;//public static void writeJson(String base,Date t,String x,Object json){}//writeJson
List<Asic>asics=new LinkedList<Asic>();//List<ThreadClass4House>houses;//File baseDir;

static MainTest01 global;

public static void main(String[]args)//class ThreadClass1 extends Thread{}
{global=new MainTest01();//baseDir=File.;
	/*{
...
public static void error(Throwable x,Object...p){try{
...
static class Asic extends TL{
	...
	public void startScan(){
		...
		*/
		try {
			...
			Object o=urlConnection.getContent(classes);
			log("Asic.startScan:urlConnection.getContent=",o);
	...
	public Asic(String ip){
		url=new URL("http",ip,80,"");
	}
	public String toJson(){return jo()
		.clrSW()
		.o("{url:",url
			,",wallet:",wallet
			,",tempr:",tempr
...
class AsicsScanner  extends TL{
	...
	public AsicsScanner (
		...
		this.prefix=prefix;this.startPort=startPort;this.endPort=endPort;this.sleep=sleep;}
}// class AsicsScanner 
...
public void logA(Object[]s){try{
 ...
 public void error(Throwable x,Object...p){try{
	...
	System.err.println(s);//h.getServletContext().log(s);
